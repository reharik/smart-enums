    ...
    sidebar: [
      {
        ...
        items: [
          ...
          {
            text: 'Coming from TypeScript enums',
            link: '/guide/coming-from-enums',
          },
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: 'Enum definitions (codegen)',
            link: '/graphql/codegen-enums',
          },
